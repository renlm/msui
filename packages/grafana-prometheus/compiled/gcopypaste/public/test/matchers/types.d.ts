...
export declare const OBSERVABLE_TEST_TIMEOUT_IN_MS = 1000;
...
export interface ObservableMatchers<R, T = {}> extends jest.ExpectExtendMap {
    ...
    toEmitValuesWith<E = ObservableType<T>>(received: T, expectations: (received: E[]) => void): Promise<jest.CustomMatcherResult>;
}
