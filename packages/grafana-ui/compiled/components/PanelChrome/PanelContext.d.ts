...
import { EventBus, DashboardCursorSync, AnnotationEventUIModel, ThresholdsConfig, CoreApp, DataFrame, DataLinkPostProcessor } from '@grafana/data';
...
export declare const PanelContextRoot: React.Context<PanelContext>;
/**
 * @alpha
 */
export declare const PanelContextProvider: React.Provider<PanelContext>;
/**
 * @alpha
 */
