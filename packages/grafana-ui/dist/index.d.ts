...
declare class PopoverController extends Component<Props$1g, State$6> {
    private hideTimeout;
    state: {
        show: boolean;
    };
...
declare class Input$1 extends PureComponent<Props$1d, State$5> {
    static defaultProps: {
        className: string;
    };
    state: State$5;
...
interface BaseProps$2 extends Omit<React__default.ButtonHTMLAttributes<HTMLButtonElement>, 'aria-label'> {
    /** Name of the icon **/
    name: IconName;
...
type Props$1c = BasePropsWithTooltip | BasePropsWithAriaLabel;
declare const IconButton: React__default.ForwardRefExoticComponent<Props$1c & React__default.RefAttributes<HTMLButtonElement>>;
...
interface Props$1b extends HTMLAttributes<HTMLDivElement> {
    className?: string;
}
declare const ButtonGroup: React__default.ForwardRefExoticComponent<Props$1b & React__default.RefAttributes<HTMLDivElement>>;
...
declare const ConfirmButton: {
    ({ children, className, closeOnConfirm, confirmText, confirmVariant, disabled, onCancel, onClick, onConfirm, size, }: Props$1a): React__default.JSX.Element;
    displayName: string;
};
...
declare function Popover({ content, show, placement, className, wrapperClassName, referenceElement, renderArrow, ...rest }: Props$18): React__default.JSX.Element | undefined;
...
declare function TabbedContainer({ tabs, defaultTab, closeIconTooltip, onClose, testId }: TabbedContainerProps): React__default.JSX.Element;
...
declare const Cascader: React__default.FunctionComponent<{
...
declare const EmptyState: ({ button, children, image, message, hideImage, variant, role, }: React__default.PropsWithChildren<Props$12>) => React__default.JSX.Element;
...
declare const DateTimePicker: ({ date, maxDate, minDate, label, onChange, disabledHours, disabledMinutes, disabledSeconds, showSeconds, clearable, }: Props$X) => React__default.JSX.Element;
...
type Props$W<TableData extends object> = WithExpandableRow<TableData> | WithoutExpandableRow<TableData>;
/** @alpha */
declare function InteractiveTable<TableData extends object>({ className, columns, data, getRowId, headerTooltips, pageSize, renderExpandedRow, showExpandAll, fetchData, }: Props$W<TableData>): React__default.JSX.Element;
...
declare const TagList: React__default.NamedExoticComponent<Omit<Props$R & React__default.RefAttributes<HTMLUListElement>, "ref"> & {
    ref?: React__default.RefObject<HTMLUListElement> | ((instance: HTMLUListElement | null) => void) | null | undefined;
}> & {
...
type PropsWithDefaults<V, D> = Props$E<V, D> & DefaultProps;
interface State$3<V> {
    values: V[];
}
...
interface BoxProps extends FlexProps, SizeProps, Omit<React__default.HTMLAttributes<HTMLElement>, 'className' | 'style'> {
...
interface StackProps extends FlexProps, SizeProps, Omit<React__default.HTMLAttributes<HTMLElement>, 'className' | 'style'> {
    gap?: ResponsiveProp<ThemeSpacingTokens>;
    alignItems?: ResponsiveProp<AlignItems>;
    justifyContent?: ResponsiveProp<JustifyContent>;
    direction?: ResponsiveProp<Direction>;
...
interface Props$d extends Props$14 {
 ...
 * @alpha
 */
declare const TooltipPlugin2: ({ config, hoverMode, render, clientZoom, queryZoom, onSelectRange, maxWidth, syncMode, syncScope, }: TooltipPlugin2Props) => React__default.ReactPortal | null;
...
declare const TimeSeries: React__default.FunctionComponent<{
    ...
    tweakScale?: ((opts: ScaleProps, forField: _grafana_data.Field<any>) => ScaleProps) | undefined;
    tweakAxis?: ((opts: AxisProps, forField: _grafana_data.Field<any>) => AxisProps) | undefined;
...
declare const LegacyForms: {
    ...
    Switch: React$1.FunctionComponent<{
        ...
        disabled?: boolean | undefined;
        onChange: (event: React$1.SyntheticEvent<HTMLInputElement, Event>) => void;
