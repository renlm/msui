...
const ReactMonacoEditor = (props) => {
  ...
  return /* @__PURE__ */ React__default.createElement(Editor, __spreadProps(__spreadValues({}, props), { theme: theme.isDark ? "grafana-dark" : "grafana-light", beforeMount: onMonacoBeforeMount }));
};
